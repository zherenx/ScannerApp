...
//                let motionData = MotionData(deviceMotion: validData, bootTime: self.bootTime)
    ...
    private func generateStreamInfo() -> [ImuStreamInfo] {
        ...
        let rotationRateStreamInfo = ImuStreamInfo(id: "rot_1", type: Constants.Sensor.Imu.RotationRate.type, encoding: imuFileEncoding, numberOfFrames: numberOfMeasurements, frequency: imuFrequency, fileExtension: Constants.Sensor.Imu.RotationRate.fileExtension)
        let userAccelerationStreamInfo = ImuStreamInfo(id: "acce_1", type: Constants.Sensor.Imu.UserAcceleration.type, encoding: imuFileEncoding, numberOfFrames: numberOfMeasurements, frequency: imuFrequency, fileExtension: Constants.Sensor.Imu.UserAcceleration.fileExtension)
        let magneticFieldStreamInfo = ImuStreamInfo(id: "mag_1", type: Constants.Sensor.Imu.MagneticField.type, encoding: imuFileEncoding, numberOfFrames: numberOfMeasurements, frequency: imuFrequency, fileExtension: Constants.Sensor.Imu.MagneticField.fileExtension)
        let attitudeStreamInfo = ImuStreamInfo(id: "atti_1", type: Constants.Sensor.Imu.Attitude.type, encoding: imuFileEncoding, numberOfFrames: numberOfMeasurements, frequency: imuFrequency, fileExtension: Constants.Sensor.Imu.Attitude.fileExtension)
        let gravityStreamInfo = ImuStreamInfo(id: "grav_1", type: Constants.Sensor.Imu.Gravity.type, encoding: imuFileEncoding, numberOfFrames: numberOfMeasurements, frequency: imuFrequency, fileExtension: Constants.Sensor.Imu.Gravity.fileExtension)
